...
import PricingHeader from './Header'; // Adjust path if needed
import PricingTiersSection from './TiersSection'; // Adjust path if needed
import FeatureComparisonSection from './ComparisonSection'; // Adjust path if needed

const plansData = {
  monthly: [
    {
      id: 'starter_monthly', name: 'Starter Spark', price: 29, description: 'Perfect for individuals & small teams launching their first pitches.', billingNote: 'Billed monthly, cancel anytime.',
      features: [
    ...
    {
      id: 'enterprise_monthly', name: 'Enterprise Scale', price: 199, description: 'Tailored solutions for large organizations with specific requirements.', billingNote: 'Billed monthly, custom terms.',
      features: [
...
export default function PricingPage() {
  ...
  const handleChoosePlan = (planId) => {
    ...
    alert(`You've selected the plan with ID: ${planId}. Redirecting to signup/checkout... (simulated)`);
  };
