...
import { CustomDropdown } from '../Common/CustomDropdown'; // Adjust path if needed
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <section className={sectionWrapper}>
          ...
          <div className="mt-6 flex items-start justify-between">
            ...
            <button type="button" onClick={() => setMembership(!membership)} className={`${toggleBase} mt-1 ${membership ? toggleChecked : toggleUnchecked}`}>
        ...
        <section className={sectionWrapper}>
            <h2 className="text-xl font-semibold text-slate-900 mb-6 flex items-center">
             ...
             <div className="mt-6 flex items-start justify-between">
                ...
                <button type="button" onClick={() => setMaintenanceMode(!maintenanceMode)} className={`${toggleBase} mt-1 ${maintenanceMode ? toggleChecked : toggleUnchecked}`}>
