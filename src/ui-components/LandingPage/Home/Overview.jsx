            ...
            <section className="p-8 sm:p-12 mx-auto bg-[#F9FAFB]">
                <div className="grid lg:grid-cols-12 gap-10 items-start">
                    ...
                    <p className="text-left font-semibold text-brand-green mb-2">Overview</p>
                        ...
                        <button className="mt-6 inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm sm:px-6 sm:py-2.5 sm:text-base font-semibold text-white bg-brand-gradient shadow hover:opacity-90 transition-opacity">
                            See How It Works
                            <Menu size={16} />
                        </button>
                    </div>
